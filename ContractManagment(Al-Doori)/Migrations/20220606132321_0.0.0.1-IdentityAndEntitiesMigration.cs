...
{
    public partial class _0001IdentityAndEntitiesMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "b03ef7f8-d6ef-4ed2-ba0f-10932b7046f5", "Admin", "ADMIN" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, "2021/03/04", "AEGON", 234, "2022/03/04", "2023/03/04" });

            migrationBuilder.InsertData(
                table: "Contract",
                columns: new[] { "Id", "ClientID", "ConclusionDate", "Institution", "RegisterationNumber", "TerminationDate", "ValidityDate" },
                values: new object[] { 2, 2, "2021/03/06", "CBOS", 425, "2022/03/06", "2023/03/06" });
            ...
            migrationBuilder.InsertData(
                table: "AdvisorContract",
                columns: new[] { "Id", "AdvisorID", "ContractID", "isAdminstrator" },
                values: new object[] { 2, 2, 1, 0 });

            migrationBuilder.InsertData(
                table: "AdvisorContract",
                columns: new[] { "Id", "AdvisorID", "ContractID", "isAdminstrator" },
                values: new object[] { 3, 4, 2, 1 });
